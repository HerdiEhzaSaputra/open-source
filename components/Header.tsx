...
export default function Header() {
    ...
    return (
        <header>
            ...
            <nav className={tw`fixed z-20 w-full bg-white dark:bg-gray-900 backdrop-blur navbar shadow-lg border-b border-gray-100 dark:border-gray-800 peer-checked:${prose} dark:shadow-none`}>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0 lg:py-5">
                        <div className="w-full items-center flex justify-between lg:w-auto">
                            <a className="relative z-10" href="/" aria-label="logo">
                                <svg className="h-9 text-primary dark:text-primaryLight" viewBox="0 0 942 272" fill="none" xmlns="http://www.w3.org/2000/svg">
